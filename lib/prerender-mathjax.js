...
function renderMath(context, opts) {
  var defaults = require('../mathjax-defaults');
  ...
  return function* () {
    ...
    if(context.body) {
      ...
      context.body.end(yield processHTML(html, opts));
    }
  }
}
